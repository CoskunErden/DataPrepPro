...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_show_missing_values(self):
        # This function visualizes data, so we do not have an assertion.
        # Instead, we call the method to ensure it runs without errors.
    ...
    def test_remove_missing_values(self):
        ...
        self.assertListEqual(list(cleaned_df_high_threshold.columns), ['C', 'E'])
